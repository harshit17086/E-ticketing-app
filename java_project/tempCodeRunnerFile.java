...
//     ETicketingProject() {
//         setBackground(Color.red); // Changed the background color here
//         // Main Panel
//         Panel mainPanel = new Panel();
//         mainPanel.setLayout(new BorderLayout());
//         mainPanel.setBackground(new Color(144, 238, 144)); // Changed the background color here

//         // Headline Panel
//         Panel headlinePanel = new Panel();
//         headlinePanel.setBackground(Color.lightGray); // Changed the background color here
...
//         loginBoxPanel.setBackground(Color.blue);
